<template>
  ...
  <div class="fixed bottom-0 left-0 hidden sm:block">
  ...
  <div class="absolute z-4 mt-24">
    ...
    <form class="px-8 pt-6 pb-8 mb-4">
      ...
      <p class="py-2">You already have an account<router-link to="/login" class="text-green-500"> Sign In</router-link> </p>
