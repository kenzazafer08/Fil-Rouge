          ...
          <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
              ...
              >
                ...
                <td class="px-6 py-4">
                  <router-link :to="{name : 'Editpostcategorie' , params:{id : cat.id }}"
    ...
    methods: {
      ...
      register() {
        ...
        console.log(this.formData);
          axios
            .post("http://127.0.0.1:8000/api/postcategorie/store", this.formData, {
              headers: {
                "Content-Type": "multipart/form-data",
                Authorization: `Bearer ${token}`, // include the token in the headers of the API request
              },
      ...
      deleteCategory(cat) {
        const token = localStorage.getItem("token");
        axios
          .delete("http://127.0.0.1:8000/api/postcategorie/delete/" + cat, {
            headers: {
              Authorization: `Bearer ${token}`, // include the token in the headers of the API request
            },
          })
